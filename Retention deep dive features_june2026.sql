create  table prod_etl_temp.retention_deep_dive as 
      ...
      -- zones
        ...
        DATEDIFF(second,
            CASE WHEN j.ref_vehicle_category_id IN
                 ...
                 THEN (j.accepted_ride_timestamp AT TIME ZONE 'UTC') AT TIME ZONE 'Asia/Dubai'
            END,
...
first_trips AS (
    ...
    WHERE trip_rank   = 1
      AND journey_dt >= '2026-05-20'
      AND journey_dt <  '2026-07-02'    -- 21 days needed to observe churn for these users
)
